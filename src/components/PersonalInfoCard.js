...
const PersonalInfoCard = () => {
    ...
    return (
        <div className="group px-4 pb-4 pt-20">
            ...
            <p className='text-gray-100 text-lg mb-4'>I’m an intermediate Javascript developer. I’ve focused my work on Website based applications(Frontend), Backend and DevOps. I specialize in Website design, Complex UI, Animations, E-commerce, POS, CI/CD, anything related to Web.</p>
